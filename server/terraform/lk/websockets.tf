...
resource "aws_apigatewayv2_api" "ws" {
  name = "LKTemplate-templateapi-gateway"
...
resource "aws_apigatewayv2_stage" "ws" {
  ...
  name = "LKTemplate-templateapi-gateway-stage"
  auto_deploy = true
...
resource "aws_cloudwatch_log_group" "ws_api" {
  name = "LKTemplate-templateapi-ws-gateway-log"
...
resource "aws_iam_policy" "api_gateway_ws" {
  name        = "LKTemplate-templateapi-api_gateway_ws"
  path = "/lktemplate/templateapi/api_gateway_ws/"
  description = "Access to the LKTemplate-templateapi_api_gateway_ws management"
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
